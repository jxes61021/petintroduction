...
const routes = [
  {
    ...
    meta,
    alias: [],
    component: () => import('./index.44b4aa8e.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    const ErrorComponent = vue_cjs_prod.defineAsyncComponent(() => import('./error-component.7359440e.mjs'));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: vue_cjs_prod.defineAsyncComponent(() => import('./default.b8ddbc4d.mjs'))
};
