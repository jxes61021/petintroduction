...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.5cef2908.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.c0e3e5b3.mjs'));
...
//# sourceMappingURL=error-component.cb39902f.mjs.map
