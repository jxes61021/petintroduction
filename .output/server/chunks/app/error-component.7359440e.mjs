...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = vue_cjs_prod.defineAsyncComponent(() => import('./error-404.7ab1064e.mjs'));
    const _Error = vue_cjs_prod.defineAsyncComponent(() => import('./error-500.238166b1.mjs'));
...
//# sourceMappingURL=error-component.7359440e.mjs.map
